 ...
 */
class PurchaseSuggestHistorySearch extends PurchaseSuggestHistory
{
    public $start_time;
    public $end_time;
    public $amount_1;
    ...
    //    $query->andWhere(['!=','product_status',7]);
        ...
        if(!empty($params)){
            if(!empty($params['PurchaseSuggestHistorySearch']['buyer_id'])){
