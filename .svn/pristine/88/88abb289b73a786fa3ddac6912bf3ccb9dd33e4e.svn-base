...
<div class="purchase-order-items-search">
    ...
    <div class="col-md-1">
        <?= $form->field($model, 'open.status')->dropDownList(PurchaseOrderServices::getTicketOpenStatus(),[])->label('订单状态')?>
    </div>
    <div class="col-md-1">
    ...
    <div class="col-md-1"><?= $form->field($model, 'custom_number')->label('报关单号') ?></div>
