...
?>
    <div class="purchase-order-index">
        ...
        <p class="clearfix"></p>
        <p>
            <?= Html::a('确认添加', ['overseas-purchase-demand/add-temporary'], ['class' => 'btn btn-success','id'=>'adds']) ?>
        </p>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format'=>'raw',
                    'value'=> function ($model) {
                        return !empty($model->transit_warehouse)?BaseServices::getWarehouseCode($model->transit_warehouse):'';
                    },
...
<?php
$url = Url::toRoute(['overseas-purchase-demand/create-purchase-order']);
