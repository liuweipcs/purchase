 ...
 */
class ReturnGoodsSearch extends ReturnGoods
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['pur_number', 'supplier_code', 'supplier_name', 'sku', 'pro_name', 'create_user', 'buyer', 'create_time'
                , 'return_number', 'freight', 'express_no', 'cargo_company'], 'safe'],
        ];
    }
...
//            'create_time' => $this->create_time,
        ...
        $query->andFilterWhere(['like', 'pur_number', trim($this->pur_number)])
            ...
            ->andFilterWhere(['like', 'return_number', trim($this->return_number)])
