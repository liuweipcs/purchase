...
$this->title = '海外仓订单合同-不含税';
?>
<?php if(isset($print)): ?>

    <table class="my-table2">
        <tr>
            <th colspan="8" style="text-align: center;"><h4>YIBAI TECHNOLOGY LTD采购订单合同</h4></th>
        </tr>
        <tr>
    ...
    <table class="my-table2">
        ...
        <tr>
            <td>其它</td>
            <td colspan="6"><?= $model->note_other ?></td>
        </tr>
        <tr>
            <th>送货方式</th>
        ...
        <tr>
            ...
            <td colspan="5" style="font-size: 20px;">
                <?php $plan = \app\models\PurchaseCompact::PaymentPlan3($model->settlement_ratio, $totalprice, $model->freight, $model->discount, 1);?>
...
<?php else: ?>
    ...
    <div class="compact-content">
        ...
        <table class="my-table2">
            <tr>
                <th colspan="8">YIBAI TECHNOLOGY LTD采购订单合同</th>
            </tr>
            <tr>
                <th colspan="4">甲方信息</th>
                <th colspan="4">乙方信息</th>
            ...
            <tr>
                <th>公司名</th>
                <td colspan="3">
                    <input type="text" name="Compact[j_company_name]" value="YIBAI TECHNOLOGY LTD">
                </td>
                <th>公司名</th>
                <td colspan="3">
            ...
            <tr>
                <th>地  址</th>
                <td colspan="3">
                    <input type="text" name="Compact[j_address]" value="UNIT 04,7/F BRIGHT WAY TOWER NO.33 MONG KOK RD KL">
                </td>
                <th>地  址</th>
                <td colspan="3">
        ...
        <table class="my-table2">
            ...
            <tr>
                ...
                <td colspan="7">
                    ...
                    $plan = \app\models\PurchaseCompact::PaymentPlan3($data['settlement_ratio'], $total_money, $freight['freight'], $freight['discount']);
