...
<!--       --><?php //Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->stockin_id], [
...
//        ])?>
    ...
    <div class="row">
        ...
        <div class="col-md-2"><?= $form->field($model, 'supplier_name')->textInput(['maxlength' => true,'placeholder'=>'易佰网络', 'disabled'=>'disabled']) ?></div>
       ...
       <!-- <div class="col-md-4"><?/*= $form->field($model, 'esupplier_name')->textInput(['maxlength' => true,'placeholder'=>'yibai network','disabled'=>'disabled']) */?></div>-->
        <div class="col-md-2"><?= $form->field($model, 'cooperation_type')->dropDownList(\app\services\SupplierServices::getCooperation(), ['prompt' => '请选择合作类型','disabled'=>'disabled']) ?></div>
        <div class="col-md-2"><?= $form->field($model, 'main_category')->dropDownList(BaseServices::getCategory(), ['prompt' => '请选择主营品类','disabled'=>'disabled']) ?></div>
        <div class="col-md-2"><?= $form->field($model, 'buyer')->dropDownList(BaseServices::getEveryOne(), ['prompt' => '请选择采购员','disabled'=>'disabled']) ?></div>
        ...
        <div class="col-md-2"><?= $form->field($model, 'payment_cycle')->dropDownList(\app\services\SupplierServices::getPaymentCycle(), ['prompt' => '请选择支付周期类型','disabled'=>'disabled']) ?></div>
        <div class="col-md-2"><?= $form->field($model, 'supplier_settlement')->dropDownList(\app\services\SupplierServices::getSettlementMethod(), ['prompt' => '请选择结算方式','disabled'=>'disabled']) ?></div>
        <div class="col-md-2"><?= $form->field($model, 'payment_method')->dropDownList(\app\services\SupplierServices::getDefaultPaymentMethod(), ['prompt' => '请选择支付方式','disabled'=>'disabled']) ?></div>
        ...
        <div class="col-md-2"><?= $form->field($model, 'product_handling')->dropDownList(\app\services\SupplierServices::getBadProductHandling(), ['prompt' => '请选择不良品处理方式','disabled'=>'disabled']) ?></div>
        <!--<div class="col-md-4"><?/*= $form->field($model, 'commission_ratio')->textInput(['maxlength' => true,'disabled'=>'disabled']) */?></div>-->
        <div class="col-md-2"><?= $form->field($model, 'purchase_amount')->textInput(['maxlength' => true,'placeholder'=>'RMB','disabled'=>'disabled']) ?></div>
        ...
        <div class="col-md-4"><?/*= $form->field($model, 'area')->dropDownList(BaseServices::getCityList($model->city),['prompt'=>'--请选择区--','disabled'=>'disabled',]) */?></div>-->
        <div class="col-md-2"><?= $form->field($model, "status")->dropDownList(['1'=>'可用','0'=>'不可用'],['class' => 'form-control pay_method','disabled'=>'disabled']) ?></div>
        <div class="col-md-2"><?= $form->field($model, "is_taxpayer")->dropDownList(Yii::$app->params['boolean'],['class' => 'form-control pay_method','disabled'=>'disabled']) ?></div>
        <div class="col-md-2"><?= $form->field($model, 'taxrate')->textInput(['maxlength' => true,'placeholder'=>'','disabled'=>'disabled']) ?></div>
        <div class="col-md-4"><?= $form->field($model, 'supplier_address')->textarea(['maxlength' => true,'disabled'=>'disabled'])->label('详细地址') ?></div>
    </div>
    <?php
   //支付方式
    if($model->pay)
