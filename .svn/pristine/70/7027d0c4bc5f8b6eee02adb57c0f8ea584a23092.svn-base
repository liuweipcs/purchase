            ...
            [
                ...
                'buttons' => [
                    'update' => function ($url, $model, $key) {
                        return Html::a('采购单',['fba-purchase-suggest-supplier/create-purchase-supplier', 'supplier_code' => $model->supplier_code,'warehouse_code'=>$model->warehouse_code,'flag'=>'1'], ['class' => "btn btn-xs btn-success create-purchase", 'title' => '生成采购订单','data-toggle' => 'modal','data-target' => '#create-purchase-modal']);
                    },
                ]
            ],
        ],
