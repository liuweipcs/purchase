            ...
            <div class="col-md-4">
                ...
                <div class="form-group field-purchaseorder-is_transit">
                    ...
                    <div id="purchaseorder-is_transit">
                        <label><input id="check-radio1" type="radio" name="PurchaseOrdersV2[is_transit]" value="0"> 需要中转</label>
                        <label><input id="check-radio2" type="radio" name="PurchaseOrdersV2[is_transit]" value="1" checked=""> 直发</label>
                    </div>
