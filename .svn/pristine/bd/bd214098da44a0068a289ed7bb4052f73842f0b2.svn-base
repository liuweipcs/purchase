...
<div style="margin-top: 175px;padding-left: 8px;">
...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'value'=>
                function($model, $key, $index, $column){
                    ...
                    $data = '<p>供应商：'. BaseServices::getSupplierName($model->supplier_code).'</p>';
        ...
        [
            ...
            'dropdown' => false,
            'width'=>'180px',
            'template' => '<p>{complete}</p><p>{view}</p><p>{note}</p>',
            'buttons' => [
                ...
                'view' => function ($url, $model, $key) {
                    return Html::a('<i class="glyphicon glyphicon-eye-open"></i> 合同明细', ['purchase-compact/view', 'cpn' => $model->pur_number], [
        ...
        'lastPageLabel' => '末页',
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value'=>
                            function($model, $key, $index, $column){
                                ...
                                $data = Yii::t('app','供应商'). '：' . PurchaseOrder::getSupplierName($model->pur_number) . "<br />";
                    ...
                    [
                        ...
                        'dropdown' => false,
                        'width'=>'180px',
                        'template' => '{complete}{view}{remarks}',
                        'buttons'=>[
                            'complete' => function ($url, $model, $key) {
                                $arr =['0','5','2'];
                               // if(!in_array($model->pay_status,$arr)) {
