...
?>
<div class="purchase-qc-putaway-index">
            ...
            [
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        $url = "/purchase-qc-putaway/view-detail?express_no={$model->express_no}&pur_number={$model->pur_number}&handle_type={$model->handle_type}" ;
                    ...
                    'update' => function ($url, $model) {
                        if($model->qc_status==2){
                            $url = "/purchase-qc-putaway/audit-detail?express_no={$model->express_no}&pur_number={$model->pur_number}&handle_type={$model->handle_type}" ;
                            return Html::a("<span class='label label-warning'>审核</span>", $url, ['title' => '编辑', 'class'=>'handle-detail','data-toggle'=>'modal','data-target'=>'#view-detail-modal']);
                        }
                    },
                ],
            ],
