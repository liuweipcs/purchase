    ...
    <?php foreach ($model as $ak => $item) { ?>
        ...
        <div class="col-md-12" style="border: 1px solid red;">
            ...
            <?php
                ...
                $freight = 0;
                $freight1 = \app\models\PurchaseOrderShip::find()->where(['pur_number'=>$item['pur_number']])->sum('freight');
                $freight2 = 0;
            ...
            if(!empty($item->purchaseOrderPayType)) {
                ...
                $real_price = $item->purchaseOrderPayType->real_price;
            ...
            <div class="form-group field-purchaseorder-pur_number required col-md-1">
                <label class="control-label" for="purchaseorder-pur_number">结算比例:</label>
                <input type="text" class="form-control" value="<?=$settlement_ratio ?>" disabled="disabled" >
            </div>

            <div class="form-group field-purchaseorder-pur_number required col-md-1">
                <label class="control-label" for="purchaseorder-pur_number">结算比例结果:</label>
                <input type="text" class="form-control" value="<?=$txt ?>" disabled="disabled" >
            </div>

            <div class="form-group field-purchaseorder-pur_number required col-md-1">
                <label class="control-label">是否退税:</label>
                <input type="text" class="form-control" value="<?=!empty($item->is_drawback) ? ($item->is_drawback==2?'是' : '否') : '否';?>" disabled="disabled">
            </div>
            ...
            <table class="table table-bordered">
                ...
                foreach ($item['purchaseOrderItems'] as $v) {
                    ...
                    <tr class="pay_list" style="width: 10%">
                        ...
                        <td><?=\app\models\ProductTaxRate::getRebateTaxRate($v['sku']); ?></td>
                    </tr>
                <?php } ?>
            </table>
