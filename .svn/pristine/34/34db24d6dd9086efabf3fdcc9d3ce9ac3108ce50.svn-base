...
<div class="stockin-view">
    ...
    <div class="row">
        ...
        <div class="col-md-2"><?= $form->field($model, 'created_at')->textInput(['disabled'=>'disabled'])->label('总应付金额') ?></div>
        <div class="col-md-2"><?= $form->field($model, 'creator')->textInput( ['disabled'=>'disabled'])->label('总实际支付金额') ?></div>
        <div class="col-md-2"><?= $form->field($model, 'pay_ship_amount')->textInput(['disabled'=>'disabled']) ?></div>
        <div class="col-md-2"><?= $form->field($model, 'pay_type')->textInput(['disabled'=>'disabled'])->label('付款状态') ?></div>
        ...
        <div class="col-md-2"><?= $form->field($model, 'purchas_status')->textInput(['maxlength' => true,'disabled'=>'disabled']) ?></div>
        ...
        <div class="col-md-2"><?= $form->field($model, 'merchandiser')->textInput(['maxlength' => true,'disabled'=>'disabled']) ->label('建议运输方式')?></div>
        <div class="col-md-2"><?= $form->field($model, 'merchandiser')->textInput(['maxlength' => true,'disabled'=>'disabled']) ->label('支付单号')?></div>
