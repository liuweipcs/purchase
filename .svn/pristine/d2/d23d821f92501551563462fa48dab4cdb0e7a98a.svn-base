...
<div class="basic-form">
    ...
    <table class="table table-hover ">
        ...
        <tbody class="pay">
            <tr class="pay_list ">
                <td><?=$form->field($model, "type[]")->dropDownList(['wave_up'=>'波动上升'],['class' => 'form-control','readonly'=>true,'style'=>'width:110px','value'=>'wave_up','required'=>true])->label(false)?></td>
                ...
                <td><?=$form->field($model, "days_90[]")->textInput(['value'=>isset($data['wave_up']['days_90'])?$data['wave_up']['days_90']:''])->label(false)?></td>

            </tr>
            <tr class="pay_list ">
                <td><?=$form->field($model, "type[]")->dropDownList(['wave_down'=>'波动下降'],['class' => 'form-control','readonly'=>true,'style'=>'width:110px','value'=>'wave_down','required'=>true])->label(false)?></td>
                ...
                <td><?=$form->field($model, "days_90[]")->textInput(['value'=>isset($data['wave_down']['days_90'])?$data['wave_down']['days_90']:''])->label(false)?></td>
