...
<div class="stockin-view">
    ...
    <div  class="col-md-4">采购确认备注:<?=$model->orderNote->note?></div>
    <div class="col-md-12"><?= $form->field($model, 'audit_note')->textarea(['cols'=>'5','rows'=>3,'maxlength' => true,'placeholder'=>'审批不通过请填写原因'])->label('备注')?></div><br/>
