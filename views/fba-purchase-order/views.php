...
<div class="stockin-view">
    ...
    <div class="row">
        ...
        <div class="col-md-2"><?= $form->field($model, 'pay_status')->textInput(['disabled'=>'disabled','value'=>PurchaseOrderServices::getPayStatus($model->shipping_method)])->label('付款状态') ?></div>
        ...
        <div class="col-md-2"><?= $form->field($model, 'purchas_status')->textInput(['maxlength' => true,'disabled'=>'disabled','value'=>PurchaseOrderServices::getPurchaseStatus($model->purchas_status)]) ?></div>
