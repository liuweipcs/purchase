...
<?php if(isset($print)): ?>
    <table class="my-table2 table">
        <tr><th colspan="12" style="text-align: center;"><h4 style="font-weight: bold">深圳市易佰网络科技有限公司采购订单合同</h4></th></tr>
        <tr>
        ...
        <tr>
            ...
            <th colspan="1">开票品名</th>
            <th colspan="1">开票单位</th>
        </tr>
        <?php
            $total_money = 0;
            $ctq_total = 0; //总采购数
        ...
        ?>
                ...
                foreach($items as $k=>$item):
                    //获取开票信息：调用
                    $productInfo = Product::find()->where(['sku'=>$item['sku']])->asArray()->one();
                    $declare_cname = !empty($productInfo['declare_cname'])?$productInfo['declare_cname']:''; //开票品名
                    $declare_unit = !empty($productInfo['declare_unit'])?$productInfo['declare_unit']:''; //开票单位
                    ...
                    <tr>
                        ...
                        <td><?= $declare_cname ?></td> <!-- 开票品名 -->
                        <td><?= $declare_unit ?></td> <!-- 开票单位 -->
                    </tr>
                <?php endforeach; ?>
            <?php endforeach; ?>
...
<?php else: ?>
    ...
    <div class="compact-content">
        <table class="my-table2">
            <tr><th colspan="12">深圳市易佰网络科技有限公司采购订单合同</th></tr>
            <tr>
                <th colspan="6">甲方</th>
                <th colspan="6">乙方</th>
            </tr>
            <tr>
                <th style="width: 78px;">单位名称</th>
                <td colspan="5"><input type="text" name="Compact[j_company_name]" value="深圳市易佰网络科技有限公司" style="width: 100%;border: 0px;" readonly></td>
                <th style="width: 78px;">单位名称</th>
                <td colspan="5">
            ...
            <tr>
                <th>地  址</th>
                <td colspan="5">
                    <textarea name="Compact[j_address]" style="width: 100%;border: 0px;" readonly>深圳市龙华新区清湖社区清祥路清湖科技园二区B栋268</textarea>
                </td>
                <th>地  址</th>
                <td colspan="5">
            ...
            <tr>
                ...
                <td colspan="11" style="text-align: center;">
                    <textarea name="Compact[note_other]" rows="3" style="width: 100%;">1、开票抬头：深圳市易佰网络科技有限公司，开票数量按照甲方报关数量分批提供给乙方；<br />2、发票收件信息：深圳市龙华新区清湖社区清祥路清湖科技园二区B栋268，<?=$data['buyer']?>，<?= $data['telephone']?>。</textarea>
                </td>
            </tr>
            <tr>
                <th>送货地址</th>
...
广东省东莞市塘厦镇科苑城科苑大道16号君盈购物广场一楼FBA仓101 <?= $data['buyer'] ?>转赵容17817013672
            ...
            <tr>
                ...
                <td colspan="4" style="text-align: center;">
                    ...
                    &yen;<input type="text" name="Compact[real_money]" value="<?= $total_money ?>" style="width: 100px;border: 0px;" readonly>
                </td>
                <td colspan="2">总金额（大写）</td>
                <td colspan="5" style="text-align: center;"><?= Vhelper::num_to_rmb($total_money); ?></td>
            </tr>
