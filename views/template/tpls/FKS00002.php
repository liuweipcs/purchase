...
<table class="my-table2">
    ...
    <tr>
        <td>账号</td>
        <td><?= $model->account ?></td>
        <td rowspan="5" colspan="6" style="width: 50%;vertical-align: top;"><?= $model->payment_reason ?></td>
    </tr>
    <tr>
        <td>开户行</td>
...
<?php
    ...
    <div style="width: 756px;background-color: #fff;">
        ...
        <table class="table table-bordered" style="margin-bottom: 0;">
            ...
            <tr>
                <td>开户行</td>
                <td><input type="text" class="form-control" name="Payment[payment_platform_branch]" value="<?= !empty($account) ? $account->payment_platform_branch : '' ?>"></td>
            </tr>
            <tr>
                <td>金额</td>
                <td><?= Vhelper::num_to_rmb($model->pay_price); ?></td>
            ...
            <input type="hidden" name="Payment[fk_name]" value="深圳市易佰网络科技有限公司">
