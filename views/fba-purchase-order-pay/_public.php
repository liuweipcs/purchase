    ...
    <div class="col-md-12">
        <table class="table table-bordered table-condensed">
            ...
            <tr>
                ...
                <th class="col-md-2">申请备注</th>
                <td><?= $payInfo['create_notice']; ?></td>
            </tr>
            <?php
            if($payInfo['auditor']):
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <ul class="list-unstyled">
                    ...
                    <li>本次请款数量：<strong><?= $v['yizhifu_num']?:$v['ctq']; ?></strong></li>
                </ul>
            </div>
            <div class="col-md-3">
                <?= $v['instock_date'] ?>
...
<div class="row" style="background-color: #f3f3f3;">
    <div class="col-md-12">
        ...
        <?php if(isset($payInfo['freight']) && $payInfo['freight'] > 0): ?>
            <p>运费：<em><?= $payInfo['freight'] ?></em></p>
        <?php endif; ?>
        <?php if(isset($payInfo['discount']) && $payInfo['discount']>0): ?>
            <p>优惠额：<em><?= $payInfo['discount'] ?></em></p>
        <?php endif; ?>
    </div>
</div>
