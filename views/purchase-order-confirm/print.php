    ...
    <div style="page-break-after:always;clear:both;padding-top: 20px;">
        <div style="text-align:left;margin-top: 30px;">
            <table border="0" class="print-header">
                ...
                <tr>
                    ...
                    <td style="text-align:center;width:48%"><h1>采购单</h1><br>日期：<?=$v['created_at']?><br>采购员：<?=app\services\BaseServices::getEveryOne($v['buyer'])?>
                    </td>
        ...
        <div style="clear:both;">
            <table class="list">
                ...
                <tr>
                    <td>
                        <img src='<?=$c['product_img']?>'  width='100' height='100'  class='imgPreview'/>
                    </td>
                    <td><?=$c['sku']?></td>
                    <td><?=$c['name']?></td>
                    <td><?=$c['qty']?></td>
