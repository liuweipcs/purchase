...
$handler_type = !empty($model->handler_type) ? $model->handler_type : 1;
?>
...
<div class="box box-success">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <label>处理类型</label><br/>
            <input type="radio" name="handler_type" value="1" <?php if($handler_type == 1){ ?> checked <?php } ?>> 退货
            <input type="radio" name="handler_type" value="4" <?php if($handler_type == 4){ ?> checked <?php } ?>> 正常入库
