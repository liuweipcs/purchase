...
<div class="purchase-order-form">
    ...
    <table class="table table-hover">
        <input type="hidden" name="PurchaseOrdersV2[pur_number]"   value="<?=$pur_number?>" />
        <tbody>
        <tr>
            <?php
            $arr =['5','6'];
            if(in_array($model->pay_status,$arr)){
                ?>
            <td >
                <label><input type="radio" name="PurchaseOrdersV2[refund_status]"   checked="checked" value="4">全额退款</label>
                <label><input type="text"  name="PurchaseOrdersV2[money1]" placeholder="请输入退款金额+运费"></label>
            </td>
            <td >
                <label><input type="radio" name="PurchaseOrdersV2[refund_status]"  value="3">部分退款</label>
                <label><input type="text"  name="PurchaseOrdersV2[money2]" placeholder="请输入退款金额+运费"></label>
            </td>
            <?php } else { ?>
            <td >
                <label><input type="radio" name="PurchaseOrdersV2[refund_status]"   checked="checked" value="10">作废</label>
            </td>
            <?php }?>
        </tr>
        </tbody>
