            ...
            [
                ...
                'value'=>
                    function($model){
                        ...
                        $data .=!is_array(SupplierServices::getDefaultPaymentMethod($model->beneficiary_payment_method,true)) ? Yii::t('app','支付平台').'：'.SupplierServices::getDefaultPaymentMethod($model->beneficiary_payment_method,true)."<br/>" :'1688在线付款';
