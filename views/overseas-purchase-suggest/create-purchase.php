...
<div class="purchase-suggest-create">
    <div class="purchase-suggest-form">
        <?= Html::beginForm(['create-purchase'], 'post', ['enctype' => 'multipart/form-data']) ?>
        ...
        <table class="table table-hover">
            <tr>
                ...
                <td>中转仓：<?= Html::dropDownList('PurchaseOrder[transit_warehouse]','AFN',['shzz'=>'上海中转仓库','AFN'=>'东莞中转仓库'])?></td>
        ...
        <table class="table table-hover ">
            ...
            <?php foreach ($data as $key=>$val):?>
                <tr class="pay_list ">
                    ...
                    <td>
                        <?=$val['sku'].Html::a('',['product/viewskusales', 'sku' => $val['sku'],'warehouse_code'=>$data[0]['warehouse_code']], ['class' => "glyphicon glyphicon-signal b", 'style'=>'margin-right:5px;', 'title' => '销量统计','data-toggle' => 'modal', 'data-target' => '#created-modal',]) ?>
                        <a href='<?=PurchaseHistory::getPurchaseLink($val['sku']) ?>' title='' target='_blank'>
