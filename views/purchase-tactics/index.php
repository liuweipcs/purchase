...
Modal::begin([
    'id' => 'basic-create',
    'header' => '<h4 class="modal-title">基础数据设置</h4>',
...
<div class="product-index">
    ...
    <p class="clearfix"></p>
    <p>
        <?= Html::a('基础数据设置', '#', ['class' => 'btn btn-success','id'=>'basic-create','data-toggle' => 'modal','data-target' => '#basic-create']) ?>

        <?= Html::a('运行补货策略', '#', ['class' => 'btn btn-success', 'id' => 'batchgetdata','target'=>'_blank']) ?>
        <?= Html::a('补货说明', ['desc'], ['class' => 'btn btn-success','id'=>'desc','data-toggle' => 'modal','data-target' => '#basic-create']) ?>
    </p>
    <?= GridView::widget([
