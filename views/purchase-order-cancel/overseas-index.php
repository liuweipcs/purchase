...
?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <?php echo $this->render('_overseas-search', ['model'=>$searchModel]); ?>
        </div>
    </div>
        ...
        [
            ...
            'buttons' => [
                ...
                'audit' => function($url, $model, $key) {
                    if ($model->audit_status == 1 && $model->purchase_type!=4) {
                ...
                'delete' => function($url, $model, $key) {
                    ...
                    if ( in_array($audit_status, $allow_delete) && ($model->purchase_type!=4) && ( $model->buyer==$username  || BaseServices::getIsAdmin()) ) {
